...
const Register: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Failed to register. Email may already exist.');
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-primary-100 py-12">
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-4xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-primary-700 mb-2">Resident Registration</h1>
        ...
        {success && createdCredentials && (
          <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded mb-4">
            ...
            <p className="mb-2">Your account has been created. Please save your credentials:</p>
            ...
            <p className="text-sm mt-2 text-yellow-700 font-medium">⚠️ Please save these credentials before leaving this page!</p>
            <p className="text-sm mt-1">Redirecting to login page in 3 seconds...</p>
          </div>
        )}
